...
>
  <div class="flex justify-between items-center">
    ...
    <div class="hidden lg:flex xl:hidden items-center gap-1">
      <a href="/get-started">
        <button
          class="px-3 py-2 text-sm font-medium hover:bg-white/5 transition-colors rounded-md"
        >
          Start
        </button>
      </a>
  ...
  <div class="flex items-center">
    ...
    <div class="hidden lg:flex xl:hidden items-center gap-1">
      <button
        class="p-2 border border-white/5 rounded-md hover:bg-white/5 transition-colors"
      >
      ...
      <button
        class="p-2 border border-white/5 rounded-md hover:bg-white/10 transition-colors bg-[#252327]"
      >
      ...
      <div class="flex items-center bg-purple-800 rounded-md px-2 py-1 ml-1">
        <img
          src={Avatar}
          alt="User Avatar"
          class="w-6 h-6 rounded-full border border-white/5 mr-2"
        />
        <span class="text-sm font-medium text-white hidden lg:block xl:hidden"
          >John</span
        >
...
{#if isMobileMenuOpen}
  ...
  >
    <div
      class="bg-[rgba(8,6,10,0.95)] backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-4 sm:p-6"
    >
      ...
      <div class="mb-6">
        <h3
          class="text-white font-semibold text-lg mb-4 pb-2 border-b border-white/20"
        >
          Navigation
        </h3>
        <div class="space-y-1">
          <a href="/get-started" on:click={closeMobileMenu} class="block">
            <div
              class="w-full text-left px-4 py-4 text-white hover:bg-white/10 rounded-lg transition-all duration-200 border-b border-white/5"
            >
          ...
          <a href="/faqs" on:click={closeMobileMenu} class="block">
            <div
              class="w-full text-left px-4 py-4 text-white hover:bg-white/10 rounded-lg transition-all duration-200"
            >
      ...
      <div class="mb-4">
        ...
        <div class="space-y-1">
          <a href="/live" on:click={closeMobileMenu} class="block">
            <div
              class="w-full flex items-center px-4 py-4 text-white hover:bg-white/10 rounded-lg transition-all duration-200 border-b border-white/5"
            >
          ...
          <a href="/servers" on:click={closeMobileMenu} class="block">
            <div
              class="w-full flex items-center px-4 py-4 text-white hover:bg-white/15 rounded-lg transition-all duration-200 border-b border-white/5 bg-[#252327]"
            >
          ...
          <a href="/notifications" on:click={closeMobileMenu} class="block">
            <div
              class="w-full flex items-center px-4 py-4 text-white hover:bg-white/10 rounded-lg transition-all duration-200"
            >
      ...
      <div class="pt-4 border-t border-white/20">
        <div class="flex items-center px-4 py-3 bg-purple-800 rounded-lg">
          <img
            src={Avatar}
            alt="User Avatar"
            class="w-8 h-8 rounded-full border border-white/5 mr-4"
          />
          <div class="flex-1">
